...
namespace WebApp.Migrations
{
    ...
    [Migration("20210308132203_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2021, 3, 8, 13, 22, 3, 408, DateTimeKind.Utc).AddTicks(4896),
                            OrderNumber = "12345"
                        });
                });

            modelBuilder.Entity("WebApp.Data.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebApp.Data.Entities.StoreUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebApp.Data.Entities.StoreUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebApp.Data.Entities.Order", b =>
                {
                    b.HasOne("WebApp.Data.Entities.StoreUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
